...
public class MitarbeiterReg extends javax.swing.JFrame {
    ...
    public void upDateDB() {
        ...
        try {
            ...
            pstSql = sqlConn.prepareStatement("SELECT * FROM cleanapp.mitarbeiter");
            ...
            while(rsSql.next()) {
                ...
                for ( i = 1; i <= q; i++ ) {
                    ...
                    columnData.add(rsSql.getShort("mitID"));
                    columnData.add(rsSql.getShort("mitName"));
                    columnData.add(rsSql.getShort("mitSname"));
                    columnData.add(rsSql.getShort("mitMail"));
                    columnData.add(rsSql.getShort("mitAva"));
    ...
    public void MitId(){
        try{
            ...
            ResultSet rs = s.executeQuery("SELECT Max(mitID) FROM cleanapp.mitarbeiter");
            rs.next(); 
    ...
    private void jButtonMainAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMainAddActionPerformed
        ...
        try {
            ...
            pstSql = sqlConn.prepareStatement("insert into mitarbeiter(mitID, mitName, mitSname, "
                    + "mitMail, mitAva)value(?,?,?,?,?)");
            
            pstSql.setString(1, rgno);
            pstSql.setString(2, name);
            pstSql.setString(3, sName);
            pstSql.setString(4, mail);
            pstSql.setString(5, ava);
            
            pstSql.executeUpdate();
            
            JOptionPane.showMessageDialog(this, "Mitarbeiter added...");
            upDateDB();
    ...
    private void jButtonMainEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMainEditActionPerformed
        ...
        try {
            ...
            /*
            pstSql = sqlConn.prepareStatement("UPDATE worker.mitarbeiter SET mitID = ?,"
                    + "mitName = ?, "
                    + "mitSname = ?, "
                    + "mitMail = ?, "
                    + "mitAva = ?"
            ...
            */           
            ...
            String rgno = txtMitId.getText();
            */
            // doesn't work --> I think i have foun the problem
            pstSql = sqlConn.prepareStatement("UPDATE mitID SET cleanapp.mitarbeiter SET mitName = ?, mitSname = ?, mitMail = ?, mitAva = ?, WHERE mitID = ?");
         
                        
            // 1 - 5 changed --> Interesting
            
            pstSql.setString(1, name);
            pstSql.setString(2, sname);
            pstSql.setString(3, mail);
            pstSql.setString(4, ava);
            pstSql.setString(5, id);
    ...
    private void jButtonMainDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMainDeleteActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                pstSql = sqlConn.prepareStatement("DELETE FROM cleanapp.mitarbeiter WHERE mitID = ?");
                
                pstSql.setString(1, id);
