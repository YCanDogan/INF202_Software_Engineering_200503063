...
public class Arbeit extends javax.swing.JFrame {
    ...
    // Then we are going to write Connections:
    Connection conn;
    
    // Another PreparedStatements for connections: 
    PreparedStatement pst;
    PreparedStatement pst_1;
    PreparedStatement pst_2;
    PreparedStatement pst_3;
    PreparedStatement pst_4;
    PreparedStatement pst_5;
    ...
    public void LoadCatWorker() {
        ...
        try {
            ...
            pst = conn.prepareStatement("SELECT * FROM cleanapp.mitarbeiter");
    ...
    public void table_update() {
        ...
        try {
            ...
            pstSql = sqlConn.prepareStatement("SELECT * FROM cleanapp.worker");
            ...
            while(Rs.next()) {
                ...
                for(int i = 1; i <= c; i++){
                    ...
                    v2.add(Rs.getString("idworker"));
                    v2.add(Rs.getString("workerName"));
                    v2.add(Rs.getString("workerSname"));
                    v2.add(Rs.getString("workerMail"));
                    v2.add(Rs.getString("workerAva"));
    ...
    */
    ...
    private void ArbtbuttonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ArbtbuttonOkActionPerformed
        ...
        try {
            ...
            this.pst_3 = conn.prepareStatement("insert into task(mitID, cust_id, fee, date, due)values(?, ?, ?, ?, ?)");
            ...
            pst_4 = conn.prepareStatement("update mitarbeiter set mitAva = 'No' where mitID = ?");
    ...
    private void ArbtComboMitIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ArbtComboMitIDActionPerformed
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            conn = DriverManager.getConnection(dataConn,username,password);
            this.pst_1 = conn.prepareStatement("SELECT * FROM cleanapp.mitarbeiter WHERE mitID = ?");
    ...
    private void ArbttxtCustIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ArbttxtCustIDKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            try {
                ...
                pst_2 = conn.prepareStatement("SELECT * FROM customer WHERE cust_id = ?");
